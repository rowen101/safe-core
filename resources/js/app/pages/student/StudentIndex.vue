...
export default {
    ...
    watch: {
        ...
        selectedClass: function (value) {
            ...
            axios
                .get("/api/school/sections?class_id=" + this.selectedClass)
                .then((response) => {
        ...
        checked: function (value) {
            this.url = "/api/school/students/export/" + this.checked;
        },
    },
    ...
    methods: {
        ...
        deleteSingleRecord(student_id) {
            axios
                .delete("/api/school/student/delete/" + student_id)
                .then((response) => {
        ...
        deleteRecords() {
            axios
                .delete("/api/school/students/massDestroy/" + this.checked)
                .then((response) => {
        ...
        getStudents(page = 1) {
            ...
            this.$axios
                ...
                .then(() => {
                    // Now you can make your actual API request
                    ...
                    this.getStudentsUrl =
                        this.getStudentsUrlWithoutPaginate.concat(
                            "&paginate=" + this.paginate + "&page=" + page
                        );
                    return this.$axios.get(this.getStudentsUrl);
                })
                .then((response) => {
    ...
    mounted() {
        this.$axios.get("/sanctum/csrf-cookie").then(() => {
            ...
            this.$axios.get("/api/school/classes").then((response) => {
