<template>
 ...
 <img :src="'/assets/img/avatars/avatar-3.jpg'" alt="Image" class="img-fluid rounded-circle mb-2"  width="128" height="128"/>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="mb-1"><i v-html="$feather.icons['twitter'].toSvg({ width: 24, height: 24 })"></i><a href="#"> Twitter</a></li>
                            <li class="mb-1"><i v-html="$feather.icons['facebook'].toSvg({ width: 24, height: 24 })"></i><a href="#"> Facebook</a></li>
                            <li class="mb-1"><i v-html="$feather.icons['instagram'].toSvg({ width: 24, height: 24 })"></i><a href="#"> Instagram</a></li>
                            <li class="mb-1"><i v-html="$feather.icons['linkedin'].toSvg({ width: 24, height: 24 })"></i><a href="#"> LinkedIn</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                <small class="float-end text-navy"
                                    >5m ago</small
                                >
                                <strong>Vanessa Tucker</strong> started
                                following <strong>Christina Mason</strong><br />
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                <small class="float-end text-navy"
                                    >30m ago</small
                                >
                                <strong>Charles Hall</strong> posted something
                                on <strong>Christina Mason</strong>'s
                                timeline<br />
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                <small class="float-end text-navy"
                                    >1h ago</small
                                >
                                <strong>Christina Mason</strong> posted a new
                                blog<br />
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                <small class="float-end text-navy"
                                    >3h ago</small
                                >
                                <strong>William Harris</strong> posted two
                                photos on <strong>Christina Mason</strong>'s
                                timeline<br />
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                <small class="float-end text-navy"
                                    >1d ago</small
                                >
                                <strong>William Harris</strong> started
                                following <strong>Christina Mason</strong><br />
