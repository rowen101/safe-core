                    ...
                    <div class="card">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="site">
                                ...
                                <div class="mt-2" v-if="listItem.length > 0" style="max-height: 300px; overflow-y: auto;">
                                <!-- Separate List for incomplete tasks -->

                                <ContentLoader v-if="isLoadingSite" viewBox="0 0 250 110">
                        <rect
                            x="0"
                            y="0"
                            rx="3"
                        ...
                        />
                                ...
                                >
                                    ...
                                    <div class="d-flex">
                                        <i
                                            @click="handleIsActiveSite(item)"
                                            :class="{
                                                'cursor-pointer mr-2': true,
                                                'fa fa-check-circle text-primary': item.is_active === 1,
                                                'fa fa-circle text-primary': item.is_active === 0,
                                            }"
                                    ...
                                    <div  class="d-flex">
                                        <i  class="fa fa-pen text-success " @click="edit(item)"></i>
                                ...
                                <!-- List for completed tasks -->
                                  <li class="m-2 list-unstyled">
                                    <button class="btn btn-sm bg-danger" @click="toggleList"
                                         v-if="deactivelist > 0">
                                         <i :class="['fa', showList ? 'fa-arrow-down' : 'fa-arrow-right']"></i>
                                        &nbsp;Deactive List {{ deactivelist }}
...
></i>
                                        ...
                                        >
                                            <del>{{ item.site_name }}</del>
                                        </span>
                                        </div>
                                        <div class="d-flex">
                     <i  v-if="item.is_active === 1" class="fa fa-pen text-success mr-2" @click="edit(item)"></i>
    ...
    <Field name="id" v-model="formSite.id" type="text" hidden />
